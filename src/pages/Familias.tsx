...
import { familias, kpisFamilia } from "@/data/mock";
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4 mb-5">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="text-xs text-muted-foreground">{k.total} imóveis · {f.membros.length} membros</div>
                    </div>
