...
export default function Imoveis() {
  ...
  return (
    <>
      <PageHeader
        title="Imóveis"
        subtitle={isLoading ? "Carregando portfólio..." : `${filtered.length} de ${imoveis.length} no portfólio`}
        actions={
          <Button onClick={exportCSV} variant="outline" className="gap-2" disabled={isLoading}>
