...
export const TIPOLOGIAS_COMERCIAL = ["Sala comercial", "Loja", "Andar corporativo", "Galpão", "Pavilhão"];
export const TIPOLOGIAS_TERRENO = ["Terreno", "Lote em condomínio", "Área industrial"];
export const TIPOLOGIAS = [...TIPOLOGIAS_RESIDENCIAL, ...TIPOLOGIAS_COMERCIAL, ...TIPOLOGIAS_TERRENO];
...
export const mockSearchResult: MarketSearchResult = {
  ...
  listings: [
    {
      id: "l1",
      titulo: "Apto 3 dorm · Ed. Parque Itaim",
      endereco: "R. Bandeira Paulista",
      m2: 110,
      dorms: 3,
      vagas: 2,
      preco: 2380000,
    ...
    {
      id: "l2",
      titulo: "Apto 2 dorm · R. Pedroso Alvarenga",
      endereco: "R. Pedroso Alvarenga, 480",
      m2: 78,
      dorms: 2,
      vagas: 1,
      preco: 1050000,
    ...
    {
      id: "l3",
      titulo: "Apto 2 dorm · Vila Olímpia",
      endereco: "Vila Olímpia, próx. Metrô",
      m2: 68,
      dorms: 2,
      vagas: 1,
      preco: 638000,
    ...
    {
      id: "l4",
      titulo: "Apto 3 dorm reformado",
      endereco: "Av. Hélio Pellegrino, 200",
      m2: 95,
      dorms: 3,
      vagas: 2,
      preco: 1520000,
  ...
  conclusoes: {
    posicionamento:
      "Unidade-alvo de 90m² estimada em R$ 1.246.500 pela mediana regional. Quartil inferior com potencial de valorização de 8–15% reformada.",
    ofertaDemanda:
      "32 anúncios ativos em raio de 500m. Desvio padrão de R$ 2.800/m² indica mercado maduro e precificação consistente.",
    tipologiaDominante:
      "2 dormitórios = 72% da oferta. Maior liquidez histórica. 3 dorms com ticket 38% superior e menor giro.",
    competitividade:
      "Densidade de 6,4 anúncios/100m de rua — acima da média SP (4,1). Mercado com oferta diversificada.",
